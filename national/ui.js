...
<label class="wide" for="include-environment">Nearby environmental readings<select id="include-environment" name="include_environment"><option value="yes">Include USGS and acquired WQP records</option><option value="no">Water system records only</option></select><span class="field-note">Nearby streams and monitoring wells are separate evidence, not tests of your tap.</span></label>
